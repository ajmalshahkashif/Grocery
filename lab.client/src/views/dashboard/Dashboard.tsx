...
interface ProgressGroupItem1 {
    title: string
    value1: number
    value2: number
}

interface ProgressGroupItem2 {
    title: string
    icon: any
    value: number
}

interface ProgressGroupItem3 {
    title: string
    icon: any
    percent: number
    value: string
...
const Dashboard: React.FC = () => {
    const progressExample: ProgressItem[] = [
    ...
    const progressGroupExample1: ProgressGroupItem1[] = [
    ...
    const progressGroupExample2: ProgressGroupItem2[] = [
        { title: 'Male', icon: cilUser, value: 53 },
        { title: 'Female', icon: cilUserFemale, value: 43 },
    ]

    const progressGroupExample3: ProgressGroupItem3[] = [
    ...
    return (
        <>
            ...
            {/* ...rest of JSX unchanged, using typed arrays above */}
        </>
    )
}
